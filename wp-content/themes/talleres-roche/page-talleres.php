							...
							<article class="">
								<a href="<?php echo "#".get_the_ID(); ?>">				
									...
									<div class="taller-article-content">
										...
										?>
										<?php /*<div class="text-center fecha-taller"><?php echo $fecha_taller->format('j')." ".$de." ".$fecha_taller->format('F')." ".$a_las." ".$fecha_taller->format('G:i').$horas; ?></div><?php endif; ?> */?>
			...
			<?php	while ( $result->have_posts() ) : $result->the_post(); ?>
						<section class="taller-single-post scroll-content1 fadeTop-effect">
							...
							<article id="<?php echo get_the_ID(); ?>" class="w-100 mx-auto">
								...
								?>
								<div class="text-center fecha-taller test1">
										<?php 
											echo date_i18n( "d ", $unixtimestamp );
											echo "de ";
											echo date_i18n( "F", $unixtimestamp );
								...
								<?php /* <div class="text-center fecha-taller test1"><?php echo $fecha_taller->format('j')." ".$de." ".$fecha_taller->format('F')." ".$a_las." ".$fecha_taller->format('G:i').$horas; ?></div> */?>
